...
| <a name="input_delegated_event_publishing_roles"></a> [delegated\_event\_publishing\_roles](#input\_delegated\_event\_publishing\_roles) | An object representing delegation of event publishers | `list` | `[]` | no |
