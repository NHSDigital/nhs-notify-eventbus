...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_core_to_supplier_events_dlq"></a> [core\_to\_supplier\_events\_dlq](#module\_core\_to\_supplier\_events\_dlq) | https://github.com/NHSDigital/nhs-notify-shared-modules/releases/download/v2.0.20/terraform-sqs.zip | n/a |
